const $confirm = (text, buttonColor) => {
    return new Promise((resolve) => {
        ...
        as_okButton.addEventListener('click', () => { asOkay(); const back = true; if (back == true) { resolve(); }; });
        as_cancelButton.addEventListener('click', () => { asCancel(); });
...
export { $alert, $confirm, $toast, $loader_show, $loader_hide }