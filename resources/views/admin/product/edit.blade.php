...
@section('main')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form id="formedit" action="{{ route('product.update',$product -> id) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
                        <div class="col-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" value={{ $product->image_list }} hidden
                                        name="image_list" id="image_list" aria-describedby="helpId" placeholder="">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="category_id"
                                    ...
                                    @foreach ($data as $model)
                                        <option @if($product -> category -> id == $model -> id) selected @endif value="{{ $model->id }}">{{ $model->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sale_price"
                                    value={{ $product->sale_price }} id="sale_price" aria-describedby="helpId"
                                    placeholder="">
                                @error('sale_price')
                                    <small id="helpId" class="form-text   text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                @error('image')
                                    <small id="helpId" class="form-text  text-danger">{{ $message }}</small>
                                @enderror
                                <img src="" id="imageMain" width="200px" alt="">
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="STATUS" id="0" value="0" checked>
                                    Private1
                                </label>
                            </div>
                        </div>
